...
<template>
    <div class="overflow-hidden rounded-md border border-gray-200">
        <table
            class="w-full overflow-hidden text-left text-sm text-gray-900 rtl:text-right"
        >
            <thead
...
<style>
.table-list-actions {
    @apply bg-white h-fit cursor-pointer border border-r-0 border-gray-300 p-1 transition-all first:rounded-l-sm last-of-type:rounded-r-sm last-of-type:border-r [&_path]:fill-gray-400 [&_svg]:h-4 [&_svg]:w-4 hover:bg-gray-900 [&:hover_path]:fill-gray-100;
}
</style>
